...
public class GetAllOwnersForOneGameTest {
	...
	public void testOwnersOfGameId21() throws Exception {
		ResponseEntity<String> response = restTemplate.getForEntity("/user/21/owners", String.class); 
	...
	public void testGameWithoutOwner() throws Exception {
		ResponseEntity<String> response = restTemplate.getForEntity("/user/24/owners", String.class); 
		assertEquals(200, response.getStatusCodeValue());
